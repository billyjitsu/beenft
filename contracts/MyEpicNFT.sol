...
contract MyEpicNFT is ERC721URIStorage {
  ...
  constructor() ERC721 ("BeeNFT", "BNFT") {
  ...
  //to take payments need to make payable and req statement for msg.value
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "Limited Edition: 1hive bee collection.", "image": "data:image/svg+xml;base64,',
